...
b. Using PolicyMap, bring into R 2019-23 American Community Survey estimates of median household income for all counties in California.  Clean the data set.
...
d. How many years will it take for a household to pay off a house in Yolo County in 2019-23? 

```{r}
#Add comment explaining code
```

e. Which county has the largest housing value-to-income ratio in 2019-23? Smallest? 
...
b. What are the survey units for median housing values? What about for median gross rent? 

c. Take the difference between the 2018 and 2019 median housing values. Do the same for median gross rent.  Did housing values go up in Butte county? What about rent?
