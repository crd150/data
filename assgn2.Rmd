...
a. Using either the Census API or NHGIS, bring into R the following county-level variables from the 2005-2009 and 2012-2016 American Community Surveys (ACS): median housing value (variable ID "B25077_001") and median household income (variable ID "B19013_001"). 
