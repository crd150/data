...
c. Download the file oakevict.csv from Canvas (Files - Week 6 - Assignment).  The file contains 2019 housing eviction rates for census tracts in Oakland. Read this file into R and merge it into the object you created in (b). 
...
c. Summarize in your own words which race/ethnic groups are geographically clustered in Houston based on your answers in (b). 
