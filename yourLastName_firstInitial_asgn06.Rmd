...
a. Use the Census API to bring in median household income (ID: B19013_001) from the 2015-19 American Community Survey for census tracts in California.  Make sure to bring it in as a spatial object by setting `geometry = TRUE`.
