...
e. Map the BART station point locations onto the choropleth map you created in (c)
...
* Bring the data set into R. Create either a single table, chart or graph that we covered in Lab 4 or a single map that we covered in Lab 5 or Lab 8. Explain what your graphic is showing us. You must show your code to get full points for this question.
